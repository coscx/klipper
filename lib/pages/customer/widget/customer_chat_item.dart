...
class CustomerChatItemWidget extends StatefulWidget {
  ...
  CustomerChatItemWidget({required this.entity,required this.onResend, required this.onItemClick,required this.onItemLongClick,  required this.tfSender, required this.onMenuItemClick});
  @override
  CustomerChatItemWidgetState createState() => CustomerChatItemWidgetState();
}

class CustomerChatItemWidgetState extends State<CustomerChatItemWidget> {
