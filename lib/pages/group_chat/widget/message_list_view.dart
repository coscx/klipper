...
import 'package:flutter_klipper/common/widgets/chat/time_util.dart';
import 'package:flutter_klipper/pages/group_chat/widget/group_chat_item.dart';
import 'package:flutter_klipper/pages/peer_chat/widget/peer_chat_item.dart';
    ...
    return ScrollConfiguration(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              String uuids = "";
              var content =widget.messageList[index].content;
              if(content !=null){
                if(content.containsKey("uuid")){
                  if(widget.messageList[index].content!['uuid'] !=null){
                    uuids = widget.messageList[index].content!['uuid'];
                  }else{
                    final now = DateTime.now();
                    uuids = now.microsecondsSinceEpoch.toString();
                  }
