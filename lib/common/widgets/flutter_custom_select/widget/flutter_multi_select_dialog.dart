...
class CustomMultiSelectFieldDialog<T> extends StatefulWidget
  ...
  @override
  State<CustomMultiSelectFieldDialog> createState() => _CustomMultiSelectFieldState();
}

class _CustomMultiSelectFieldState<T> extends State<CustomMultiSelectFieldDialog<T>> {
  ...
  @override
  void didUpdateWidget(covariant CustomMultiSelectFieldDialog<T> oldWidget) {
    _controller.text = widget.title;
